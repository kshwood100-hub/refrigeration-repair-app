...
import { Home, ScanSearch, Wrench, BookOpen, Settings } from 'lucide-react'
...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 max-w-lg mx-auto bg-white border-t border-gray-100 flex">
